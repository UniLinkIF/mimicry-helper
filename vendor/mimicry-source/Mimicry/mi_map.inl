...
{
    return ( *this->m_pBuckets )[ this->m_uIndex ].m_Data;
}
...
mTStringMap< T >::mTStringMap( MIUInt a_uMinCapacity ) :
    mTMap< mCString, T, mTStringKeyManager< mCString > >( a_uMinCapacity )
{
}

template< typename T >
mTStringMap< T >::mTStringMap( mTStringMap< T > const & a_mapSource ) :
    mTMap< mCString, T, mTStringKeyManager< mCString > >( a_mapSource )
{
}

template< typename T >
mTNameMap< T >::mTNameMap( MIUInt a_uMinCapacity ) :
    mTMap< mCName, T, mTHashKeyManager32< mCName > >( a_uMinCapacity )
{
}

template< typename T >
mTNameMap< T >::mTNameMap( mTNameMap< T > const & a_mapSource ) :
    mTMap< mCName, T, mTHashKeyManager32< mCName > >( a_mapSource )
{
}

template< typename T >
mTIDMap< T >::mTIDMap( MIUInt a_uMinCapacity ) :
    mTMap< mCUnique::ID, T, mTHashKeyManager32< mCUnique::ID > >( a_uMinCapacity )
{
}

template< typename T >
mTIDMap< T >::mTIDMap( mTIDMap< T > const & a_mapSource ) :
    mTMap< mCUnique::ID, T, mTHashKeyManager32< mCUnique::ID > >( a_mapSource )
{
}
